...
tag="v0.1.0-alpha.14"
title="sealr 0.1.0-alpha.14: complete Deflate streams and Unicode wheel evidence"
notes=$'# sealr 0.1.0-alpha.14\n'
allowed='[
  "SHA256SUMS",
  "sealr-0.1.0-alpha.14-aarch64-apple-darwin.tar.gz",
  "sealr-0.1.0-alpha.14-x86_64-pc-windows-msvc.zip",
  "sealr-0.1.0-alpha.14-x86_64-unknown-linux-gnu.tar.gz"
]'
