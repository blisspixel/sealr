...
- The immutable Alpha.7 [wheel semantic inventory](docs/wheel-compatibility-v2.md) preserves the exact research profile, hostile fixtures, distinct identities, and historical PyPA `installer` 0.7.0 measurements.
