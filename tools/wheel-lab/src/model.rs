...
pub const CONSUMER_PROFILE_ID: &str = "sealr.consumer.python-wheel.v1-research";
...
pub struct WheelLimits {
    ...
    pub max_bridge_member_bytes: u64,
    pub max_bridge_total_bytes: u64,
...
impl Default for WheelLimits {
    fn default() -> Self {
        Self {
            ...
            max_bridge_member_bytes: 64 * 1024 * 1024,
            max_bridge_total_bytes: 512 * 1024 * 1024,
...
pub struct WheelMemberFacts {
    ...
    pub pypa_installer_0_7_executable: bool,
}
