...
impl HelperArtifact {
    ...
    pub(crate) fn verify_process_executable(&self, pid: u32) -> Result<(), HelperError> {
    ...
    pub(crate) fn source_matches(&self, path: &Path) -> Result<bool, HelperError> {
...
pub(crate) fn parse_digest(value: &str) -> Result<[u8; 32], HelperError> {
