...
> This document describes the product direction. Published Alpha.13 behavior is defined by the [README](../README.md) and [API contract](api.md). The target semantic design is specified in [semantic-model.md](semantic-model.md).
