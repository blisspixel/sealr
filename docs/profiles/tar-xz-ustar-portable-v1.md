...
> Status: supported in-process preview released in Alpha.12. This is the second promoted codec adapter beyond Deflate. Authenticated worker execution fails closed until a later semantic record can bind both snapshot domains and their transform.
