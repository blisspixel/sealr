...
Start with the [README](../README.md) for the Alpha.8 preview boundary and a short walkthrough. This index separates current contracts from plans and research notes.
...
| [Current release notes](releases/v0.1.0-alpha.8.md) | Alpha.8 contents and limitations |
...
| [Near-term execution plan](near-term.md) | Release-sized work packages through Alpha.8 and the next acceptance gates |
