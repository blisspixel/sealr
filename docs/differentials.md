...
- Alpha.8 has no mixed-container allow profile. Current main has a supported portable UTF-8 profile and wheel consumer, while future OOXML, JAR, or APK consumers each still need a versioned interpretation and consumer profile that defines permitted container structure and identity files.
