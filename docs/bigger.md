...
> Target research direction. Alpha.4 does not implement projection, mounting, content-addressed reuse, overlays, or lazy verification. The [active execution queue](../ROADMAP.md#active-execution-queue) puts semantic identity and reduced authority before this work.
