...
| Python wheel admission | Supported preview plus packaged adopter conformance landed | The public evaluator consumes only `VerifiedArchive`. An isolated extracted-package project drives exact PyPA installer 1.0.1 through real target effects after source deletion and audits the realization identity. Independent adoption remains open. |
