...
6. Pin record vectors for admitted planning, coherent denial, partial planning, malformed structure, record mutation, and worker crash. Pin separate supervisor-merge vectors for destination setup failure after planning, verification and effect failure, writer quiescence, stage audit, cleanup, publication, clone and drop behavior, retained borrows, and bounded non-retained reads.
