...
- tag: `v0.1.0-alpha.4`;
- release: <https://github.com/blisspixel/sealr/releases/tag/v0.1.0-alpha.4>;
- state: prerelease, published, immutable.

## Linux

Download `SHA256SUMS` and `sealr-0.1.0-alpha.4-x86_64-unknown-linux-gnu.tar.gz` into one directory, then run:

```sh
archive='sealr-0.1.0-alpha.4-x86_64-unknown-linux-gnu.tar.gz'
...
Download `SHA256SUMS` and `sealr-0.1.0-alpha.4-aarch64-apple-darwin.tar.gz` into one directory, then run:

```sh
archive='sealr-0.1.0-alpha.4-aarch64-apple-darwin.tar.gz'
...
Download `SHA256SUMS` and `sealr-0.1.0-alpha.4-x86_64-pc-windows-msvc.zip` into one directory, then run:

```powershell
$archive = 'sealr-0.1.0-alpha.4-x86_64-pc-windows-msvc.zip'
...
```sh
gh release verify v0.1.0-alpha.4 --repo blisspixel/sealr
```
