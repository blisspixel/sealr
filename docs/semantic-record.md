...
1. CLI, wheel-laboratory, and extracted-package consumer activation on the same fail-closed boundary;
2. accumulated clean scheduled fuzz and main-branch history, with every reproducible failure promoted to a deterministic regression.
