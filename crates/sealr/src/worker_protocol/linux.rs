...
pub const FLAG_STAGE: u8 = 1 << 0;
pub const FLAG_NO_NEW_PRIVS: u8 = 1 << 1;
pub const FLAG_CLOSE_RANGE: u8 = 1 << 2;
pub const FLAG_LANDLOCK_ENFORCED: u8 = 1 << 3;
...
pub const ERROR_PROTOCOL: u64 = 1;
pub const ERROR_DESCRIPTOR: u64 = 2;
pub const ERROR_AUTHORITY_CLOSE: u64 = 3;
pub const ERROR_RESTRICTION: u64 = 4;
pub const ERROR_PROBE: u64 = 5;
pub const DETAIL_DATA_TRUNCATED: u64 = 1 << 0;
pub const DETAIL_CONTROL_TRUNCATED: u64 = 1 << 1;
pub const DETAIL_SHORT_FRAME: u64 = 1 << 2;
pub const DETAIL_ANCILLARY_MALFORMED: u64 = 1 << 3;
pub const DETAIL_ANCILLARY_UNKNOWN: u64 = 1 << 4;
pub const DETAIL_ANCILLARY_MULTIPLE_RIGHTS: u64 = 1 << 5;
...
pub fn configure_timeout<Fd: AsFd>(socket: Fd) -> Result<(), TransportError> {
...
pub fn send_raw_conformance_packet<Fd: AsFd>(
    socket: Fd,
    bytes: &[u8],
    descriptors: &[BorrowedFd<'_>],
...
pub fn close_inherited_authority<Fd: AsFd>(control: Fd) -> Result<(), TransportError> {
...
impl TransportError {
    ...
    pub fn protocol_detail(&self) -> u64 {
        match self {
