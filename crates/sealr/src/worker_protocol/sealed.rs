//! Bounded immutable blob transport for the authenticated Linux worker.
...
pub fn create(role: BlobRole, payload: &[u8]) -> Result<OwnedFd, BlobError> {
...
pub fn create_unsealed_for_conformance(
    role: BlobRole,
    payload: &[u8],
...
pub const fn total_len(payload_len: usize) -> Option<u64> {
