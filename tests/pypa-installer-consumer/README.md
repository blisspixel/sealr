...
python3 -m pip download \
  ...
  --only-binary=:all: \
  --require-hashes \
  --requirement target/package/sealr-0.1.0-alpha.15/examples/pypa_installer_handoff/requirements.txt \
...
cargo run --locked --release \
  ...
  --bridge target/package/sealr-0.1.0-alpha.15/examples/pypa_installer_handoff/wheel_source.py \
