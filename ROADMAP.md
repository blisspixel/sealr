...
The latest published milestone is **Alpha.12: canonical evidence and independent verification**. It ships exact RFC 8785 decision evidence, a no-Sealr-dependency verifier in every native archive, a repository-owned packaged PyPA conformance path, and seven separately selected restricted format additions while retaining the project-wide alpha status.
