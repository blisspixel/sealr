...
- a dormant crate-private split-phase semantic-record experiment with independent magic, bounded hostile decode, exact supervisor correlation and source binding, pinned record vectors, a dedicated deterministic-seed target, and one clean exact-main on-demand Linux AddressSanitizer campaign; scheduled-event history remains pending.
